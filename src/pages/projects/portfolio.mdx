...
Choosing **Astro** as the framework for the portfolio had many great reasons:
    1. Fast by default (fast!🚀) due to pure html / css
    2. TailwindCSS integration (💖 TailwindCSS) 
    3. Island architecture let me use React for interactive components
